...
const GUIDE: Tab[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { t: "🧐 피드백 받기", d: "검토자(효율형 시니어·시스템·라이브운영·하드코어/라이트 유저 등) 시선으로 과잉·저효과 스펙을 솎아내요. 여러 명 패널 비교도 가능. 항목마다 보완/축소/후순위/제거/직접지시 + 메모로 골라 반영하고, 애매하면 [조던과 상의]로 넘겨요. 검토자는 직접 만들어 저장할 수 있어요." },
