            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5" style={{ scrollbarWidth: "thin", scrollbarColor: `${SILVER_DIM} transparent` }}>
              ...
              <section>
                ...
                <div className="space-y-2 text-xs" style={{ color: "#b8c4d4", lineHeight: 1.55 }}>
                  ...
                  <p><b style={{ color: SILVER }}>📄 기획서</b> — 진입 시 좌측 <b>📚 기획서 리스트</b>가 기본 열림. 리스트는 <b>대(인게임/아웃게임…) &gt; 중(영웅/PVP…) &gt; 소(영웅 등급/스킬…)</b> 3단계 카테고리로 그룹핑. 같은 기획서의 v1·v2·v3는 family로 묶임. family 옆 ✏️로 이름 일괄 변경, 📂로 3단 cascading 카테고리 분류, +/−로 펼침/접기. 안 본 버전 옆에는 <b style={{ color: "rgba(255,150,150,1)" }}>빨간 점</b>(클릭하면 영구 해제). 뷰 안에서 <b>🪄 수정 요청</b>으로 자연어 지시 → 새 버전 자동 생성.</p>
