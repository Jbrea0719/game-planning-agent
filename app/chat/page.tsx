            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5" style={{ scrollbarWidth: "thin", scrollbarColor: `${SILVER_DIM} transparent` }}>
              ...
              <section>
                ...
                <div className="space-y-2 text-xs" style={{ color: "#b8c4d4", lineHeight: 1.55 }}>
                  ...
                  <p><b style={{ color: SILVER }}>📄 기획서</b> — 지금까지 생성한 기획서 버전 열람·편집·다운로드 (MD/TXT). 신규 기획서가 있으면 <b style={{ color: "rgba(255,150,150,1)" }}>빨간 점</b> 표시 (열어보면 사라짐, 자동 해제 X). 뷰 안에서 <b>🪄 수정 요청</b>으로 자연어 지시 → 조던이 새 버전 자동 생성. 좌측 <b>📚 기획서 리스트</b> 버튼으로 카테고리별(대화 기반/수정 버전/바이블 기반) 트리 탐색.</p>
